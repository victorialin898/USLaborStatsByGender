...
One of the most significant factors driving the gender wage gap is occupation. Men and women tend to be concentrated in different types of jobs, and these occupations vary greatly in terms of pay. Occupations that are predominantly female, such as nursing, teaching, and caregiving, tend to be devalued and are generally lower-paying compared to male-dominated fields like technology, finance, and management. Then, within an occupation, there may be additional wage gaps between genders. In 2017, the Institute for Women's Policy Research published a fact sheet on the [Gender Wage Gap by Occupation in 2017](https://iwpr.org/wp-content/uploads/2020/08/C467_2018-Occupational-Wage-Gap.pdf), discusses this phenomenon, and has additional insights on these trends within races.
